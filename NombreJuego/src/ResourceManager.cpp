...
void ResourceManager::InitLoad()
{
	...
	this->BufferMetronome->loadFromFile(CURRENT_PATH + METRONOME_PATH);
	this->BufferPublicHappy->loadFromFile(CURRENT_PATH + PUBLIC_HAPPY_PATH);
	this->BufferPublicAngry->loadFromFile(CURRENT_PATH + PUBLIC_ANGRY_PATH);
	

	this->BufferBadNote1->loadFromFile(CURRENT_PATH + BUFFER_BAD_NOTE_1);
	this->BufferBadNote2->loadFromFile(CURRENT_PATH + BUFFER_BAD_NOTE_2);
	this->BufferBadNote3->loadFromFile(CURRENT_PATH + BUFFER_BAD_NOTE_3);
	this->BufferBadNote4->loadFromFile(CURRENT_PATH + BUFFER_BAD_NOTE_4);
	this->BufferBadNote5->loadFromFile(CURRENT_PATH + BUFFER_BAD_NOTE_5);
}
